...
let descUpdates2 = reducer(describeTest2, -20.4, testModel)
console.log(testModel)
console.log(testModel.players)
console.log(descUpdates)
console.log("!!!")
...
console.log()
console.log()
console.log("Player 1 has entered the game")
console.log()
console.log()
console.log()
console.log()
...
let oneModel = makeModel()
reducer({id: 0, data: {type: "SetName", name: "game-ingo"}}, 1, oneModel)
reducer(startGameTest, 1, oneModel)
let qwer = reducer({id: 0, data: {type: "Prompt", prompt: "The devil is in the dope"}}, 1, oneModel)
console.log(oneModel)
console.log(qwer)
console.log()
let asdf = reducer({id: 0, data: {type: "Draw", drawing: {dataURI: "I am a picture"}}}, 1, oneModel)
console.log(oneModel)
console.log(oneModel.players)
console.log(asdf)
console.log()
let zxcv = reducer({id: 0, data: {type: "Describe", description: "knockity knockity there is no property"}}, 1, oneModel)
console.log(oneModel)
console.log(oneModel.players)
console.log(zxcv)
console.log()
