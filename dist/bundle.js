...
var _lobby = __webpack_require__(35);

var _prompt = __webpack_require__(36);

var _draw = __webpack_require__(32);

var _describe = __webpack_require__(31);
  ...
  socket.on("update", function (updateStr) {
    ...
    if (!update.name) {
      ...
      if (update.name === "LobbyUpdate") {
        ...
        (0, _prompt.setupPrompt)(update, socket);
      } else if (update.name === "DescribeUpdate") {
        (0, _describe.setupDescribe)(update, socket);
      } else if (update.name === "DrawUpdate") {
        (0, _draw.setupDraw)(update, socket);
      } else if (update.name === "EndgameUpdate") {
        (0, _end.setupEnd)(update, socket);
      } else {
        console.log("invalid update recived: " + updateStr);
      }
    }
...
var $ = __webpack_require__(4);
var sketch = __webpack_require__(37);
sketch.sketch($);
...
var _onlyjs = __webpack_require__(18);
...
var _htmlUtils = __webpack_require__(34);

var $ = __webpack_require__(4);
window.jQuery = $;

var only = __webpack_require__(18);
...
function setupPrompt(update, socket) {
  function takePrompt() {
