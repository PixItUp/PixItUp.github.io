...
var _lobby = __webpack_require__(62);

var _prompt = __webpack_require__(63);

var _draw = __webpack_require__(59);

var _describe = __webpack_require__(58);

var _end = __webpack_require__(60);
...
$(document).ready(function () {
  var divs = new Map([["LobbyUpdate", $("#lobbyDiv")], ["PromptUpdate", $("#promptDiv")], ["DescribeUpdate", $("#describeDiv")], ["DrawUpdate", $("#drawDiv")], ["EndgameUpdate", $("#endDiv")]]);

  function setVisible(modeName) {
    window.divs = [];
    divs.forEach(function (div, name) {
      window.divs.push(div);
      div.hide();
    });
    var div = divs.get(modeName);
    if (div) {
      div.show();
    } else {
  ...
  socket.on("update", function (updateStr) {
    ...
    if (!update.name) {
      ...
      if (update.name === "LobbyUpdate") {
        (0, _lobby.setupLobby)(update, socket);
      } else if (update.name === "PromptUpdate") {
        (0, _prompt.setupPrompt)(update);
      } else if (update.name === "DescribeUpdate") {
        (0, _describe.setupDescribe)(update);
      } else if (update.name === "DrawUpdate") {
        (0, _draw.setupDraw)(update);
      } else if (update.name === "EndgameUpdate") {
        (0, _end.setupEnd)(update);
      } else {
        console.log("invalid update recived: " + updateStr);
      }
    }
...
var sketch = exports.sketch = function sketch($) {
  var Sketch;
  $.fn.sketch = function () {
    var args, key, sketch;
...
exports.setupDescribe = setupDescribe;
function setupDescribe(update, socket) {}
...
exports.setupDraw = setupDraw;
var $ = __webpack_require__(2);
var sketch = __webpack_require__(1);
sketch.sketch($);

function setupDraw(update, socket) {
...
exports.setupEnd = setupEnd;
function setupEnd(update, socket) {}
...
var _onlyjs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"onlyjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var only = _interopRequireWildcard(_onlyjs);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function removeChildren(node, newChild) {
...
var _htmlUtils = __webpack_require__(61);

var $ = __webpack_require__(2);
window.jQuery = $;

var only = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"onlyjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
function setupLobby(update, socket) {
  var tableContainer = $("#table-container")[0];
  var table = only.html({
...
exports.setupPrompt = setupPrompt;
function setupPrompt(update) {}
